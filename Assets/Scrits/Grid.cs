...
public class Grid : MonoBehaviour
{
    ...
    public void CreateSaved()
    {
        ...
        for (int i = 0; i < Objects2.Count; i++)
        {
            ...
            if (i == 0)
            {
                //Objects2[i].Rep.GetComponent<LaserDistributer>().Powered=true;
                Objects2[i].Rep.GetComponent<LaserPhysics>().SetDirection();
                //Objects2[i].Rep.GetComponent<LaserDistributer>().Connect();
            }
        }
        Objects2[0].Rep.GetComponent<LaserPhysics>().Connect();
        //TODO MAKE VIRTTUAL
        Objects2[0].Rep.GetComponent<LaserPhysics>().WasPowered = true;
    }
    ...
    public void Load()
    {
        ...
        TextAsset tx = (TextAsset)Resources.Load("level0");
    ...
    public void OnButtonPress(int i)
    {
        ...
        EnerdyCenter.Instance.SwitchOff();
        if (Objects2[i].Rep.GetComponent<RodsBase>())
        {
            ...
            foreach (var obj in Objects2)
            {
                if (obj.Rep.GetComponent<LaserDistributer>())
                    obj.Rep.GetComponent<LaserDistributer>().SwitchOff();
            }
            //TODO UNHARDCODE 
    ...
    public IEnumerator LateCall()
    {
        ...
        foreach (var obj in Objects2)
        {
            var laser = obj.Rep.GetComponent<LaserPhysics>();
            if (laser != null && laser.WasPowered)
                laser.Connect();
        }
